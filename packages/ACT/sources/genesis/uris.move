module act::uris {
    ...
    public fun get_other(name: vector<u8>, equipment: vector<u8>, colour_way: vector<u8>): (vector<u8>, vector<u8>, vector<u8>) {
        ...
        else if (name == b"Fang MK IV" && equipment ==	b"Right Hand" && colour_way ==	b"Obsidian")	(b"QmVyHepwDoojjFe97qQNYhdm5o2y5Wht6hx8KjJdtXcy4j",	b"QmQREkRpofc9k6AdSr7jjqfakc7v8iUnCbDm9tR7wTq633",	b"Qme91xCktjvK2ohEe5Z1m7fqrW9zhmwXEqvcR9tUsQxmxQ")
        else if (name == b"Fang MK IV" && equipment ==	b"Left Hand" && colour_way ==	b"Obsidian")	(b"QmSFTFWX5x8b3yHu9DhBdAf7oQ3FpK3z4X5sDur3YcAuBZ",	b"QmeAge99jdeV2ZGAhRADA8tbg6yv9hUgpQSZGPuzJfYL91",	b"Qme91xCktjvK2ohEe5Z1m7fqrW9zhmwXEqvcR9tUsQxmxQ")
