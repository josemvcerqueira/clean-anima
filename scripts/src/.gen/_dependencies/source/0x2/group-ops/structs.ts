...
export class Element<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V21}::group_ops::Element`; static readonly $numTypeParams = 1;

 readonly $typeName = Element.$typeName;

 readonly $fullTypeName: `${typeof PKG_V21}::group_ops::Element<${PhantomToTypeStr<T>}>`;
