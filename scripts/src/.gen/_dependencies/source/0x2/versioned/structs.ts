...
export class VersionChangeCap implements StructClass { static readonly $typeName = `${PKG_V21}::versioned::VersionChangeCap`; static readonly $numTypeParams = 0;
...
export class Versioned implements StructClass { static readonly $typeName = `${PKG_V21}::versioned::Versioned`; static readonly $numTypeParams = 0;
