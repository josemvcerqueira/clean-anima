...
export function isBorrow(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V20}::kiosk::Borrow`; }

export interface BorrowFields { kioskId: ToField<ID>; itemId: ToField<ID> }

export type BorrowReified = Reified< Borrow, BorrowFields >;

export class Borrow implements StructClass { static readonly $typeName = `${PKG_V20}::kiosk::Borrow`; static readonly $numTypeParams = 0;

 readonly $typeName = Borrow.$typeName;

 readonly $fullTypeName: `${typeof PKG_V20}::kiosk::Borrow`;

 readonly $typeArgs: [];

 readonly kioskId: ToField<ID>; readonly itemId: ToField<ID>

 private constructor(typeArgs: [], fields: BorrowFields, ) { this.$fullTypeName = composeSuiType( Borrow.$typeName, ...typeArgs ) as `${typeof PKG_V20}::kiosk::Borrow`; this.$typeArgs = typeArgs;

 this.kioskId = fields.kioskId;; this.itemId = fields.itemId; }

 static reified( ): BorrowReified { return { typeName: Borrow.$typeName, fullTypeName: composeSuiType( Borrow.$typeName, ...[] ) as `${typeof PKG_V20}::kiosk::Borrow`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Borrow.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Borrow.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Borrow.fromBcs( data, ), bcs: Borrow.bcs, fromJSONField: (field: any) => Borrow.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Borrow.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Borrow.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Borrow.fetch( client, id, ), new: ( fields: BorrowFields, ) => { return new Borrow( [], fields ) }, kind: "StructClassReified", } }
...
export function isItem(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V20}::kiosk::Item`; }

export interface ItemFields { id: ToField<ID> }

export type ItemReified = Reified< Item, ItemFields >;

export class Item implements StructClass { static readonly $typeName = `${PKG_V20}::kiosk::Item`; static readonly $numTypeParams = 0;

 readonly $typeName = Item.$typeName;

 readonly $fullTypeName: `${typeof PKG_V20}::kiosk::Item`;

 readonly $typeArgs: [];

 readonly id: ToField<ID>

 private constructor(typeArgs: [], fields: ItemFields, ) { this.$fullTypeName = composeSuiType( Item.$typeName, ...typeArgs ) as `${typeof PKG_V20}::kiosk::Item`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): ItemReified { return { typeName: Item.$typeName, fullTypeName: composeSuiType( Item.$typeName, ...[] ) as `${typeof PKG_V20}::kiosk::Item`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Item.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Item.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Item.fromBcs( data, ), bcs: Item.bcs, fromJSONField: (field: any) => Item.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Item.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Item.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Item.fetch( client, id, ), new: ( fields: ItemFields, ) => { return new Item( [], fields ) }, kind: "StructClassReified", } }
...
export function isItemDelisted(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V20}::kiosk::ItemDelisted` + '<'); }
...
export function isItemListed(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V20}::kiosk::ItemListed` + '<'); }
...
export function isItemPurchased(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V20}::kiosk::ItemPurchased` + '<'); }
...
export function isKiosk(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V20}::kiosk::Kiosk`; }
...
export class Kiosk implements StructClass { static readonly $typeName = `${PKG_V20}::kiosk::Kiosk`; static readonly $numTypeParams = 0;

 readonly $typeName = Kiosk.$typeName;

 readonly $fullTypeName: `${typeof PKG_V20}::kiosk::Kiosk`;
 ...
 private constructor(typeArgs: [], fields: KioskFields, ) { this.$fullTypeName = composeSuiType( Kiosk.$typeName, ...typeArgs ) as `${typeof PKG_V20}::kiosk::Kiosk`; this.$typeArgs = typeArgs;
...
export function isKioskOwnerCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V20}::kiosk::KioskOwnerCap`; }
...
export class KioskOwnerCap implements StructClass { static readonly $typeName = `${PKG_V20}::kiosk::KioskOwnerCap`; static readonly $numTypeParams = 0;

 readonly $typeName = KioskOwnerCap.$typeName;

 readonly $fullTypeName: `${typeof PKG_V20}::kiosk::KioskOwnerCap`;

 readonly $typeArgs: [];

 readonly id: ToField<UID>; readonly for: ToField<ID>

 private constructor(typeArgs: [], fields: KioskOwnerCapFields, ) { this.$fullTypeName = composeSuiType( KioskOwnerCap.$typeName, ...typeArgs ) as `${typeof PKG_V20}::kiosk::KioskOwnerCap`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.for = fields.for; }

 static reified( ): KioskOwnerCapReified { return { typeName: KioskOwnerCap.$typeName, fullTypeName: composeSuiType( KioskOwnerCap.$typeName, ...[] ) as `${typeof PKG_V20}::kiosk::KioskOwnerCap`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => KioskOwnerCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => KioskOwnerCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => KioskOwnerCap.fromBcs( data, ), bcs: KioskOwnerCap.bcs, fromJSONField: (field: any) => KioskOwnerCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => KioskOwnerCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => KioskOwnerCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => KioskOwnerCap.fetch( client, id, ), new: ( fields: KioskOwnerCapFields, ) => { return new KioskOwnerCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isListing(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V20}::kiosk::Listing`; }
...
export class Listing implements StructClass { static readonly $typeName = `${PKG_V20}::kiosk::Listing`; static readonly $numTypeParams = 0;

 readonly $typeName = Listing.$typeName;

 readonly $fullTypeName: `${typeof PKG_V20}::kiosk::Listing`;

 readonly $typeArgs: [];

 readonly id: ToField<ID>; readonly isExclusive: ToField<"bool">

 private constructor(typeArgs: [], fields: ListingFields, ) { this.$fullTypeName = composeSuiType( Listing.$typeName, ...typeArgs ) as `${typeof PKG_V20}::kiosk::Listing`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.isExclusive = fields.isExclusive; }

 static reified( ): ListingReified { return { typeName: Listing.$typeName, fullTypeName: composeSuiType( Listing.$typeName, ...[] ) as `${typeof PKG_V20}::kiosk::Listing`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Listing.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Listing.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Listing.fromBcs( data, ), bcs: Listing.bcs, fromJSONField: (field: any) => Listing.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Listing.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Listing.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Listing.fetch( client, id, ), new: ( fields: ListingFields, ) => { return new Listing( [], fields ) }, kind: "StructClassReified", } }
...
export function isLock(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V20}::kiosk::Lock`; }

export interface LockFields { id: ToField<ID> }

export type LockReified = Reified< Lock, LockFields >;

export class Lock implements StructClass { static readonly $typeName = `${PKG_V20}::kiosk::Lock`; static readonly $numTypeParams = 0;

 readonly $typeName = Lock.$typeName;

 readonly $fullTypeName: `${typeof PKG_V20}::kiosk::Lock`;

 readonly $typeArgs: [];

 readonly id: ToField<ID>

 private constructor(typeArgs: [], fields: LockFields, ) { this.$fullTypeName = composeSuiType( Lock.$typeName, ...typeArgs ) as `${typeof PKG_V20}::kiosk::Lock`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified( ): LockReified { return { typeName: Lock.$typeName, fullTypeName: composeSuiType( Lock.$typeName, ...[] ) as `${typeof PKG_V20}::kiosk::Lock`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Lock.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Lock.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Lock.fromBcs( data, ), bcs: Lock.bcs, fromJSONField: (field: any) => Lock.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Lock.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Lock.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Lock.fetch( client, id, ), new: ( fields: LockFields, ) => { return new Lock( [], fields ) }, kind: "StructClassReified", } }
...
export function isPurchaseCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V20}::kiosk::PurchaseCap` + '<'); }
