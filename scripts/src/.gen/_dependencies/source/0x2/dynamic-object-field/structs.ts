...
export function isWrapper(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V22}::dynamic_object_field::Wrapper` + '<'); }
