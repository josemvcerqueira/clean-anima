...
export class VerifiedIssuer implements StructClass { static readonly $typeName = `${PKG_V21}::zklogin_verified_issuer::VerifiedIssuer`; static readonly $numTypeParams = 0;
