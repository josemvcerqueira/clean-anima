...
export class Equip implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V1}::cosmetic::Equip`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Equip.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::cosmetic::Equip`; readonly $typeArgs: []; readonly $isPhantom = Equip.$isPhantom;
...
export class COSMETIC implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::cosmetic::COSMETIC`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = COSMETIC.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::cosmetic::COSMETIC`; readonly $typeArgs: []; readonly $isPhantom = COSMETIC.$isPhantom;
 ...
 static reified( ): COSMETICReified { return { typeName: COSMETIC.$typeName, fullTypeName: composeSuiType( COSMETIC.$typeName, ...[] ) as `${typeof PKG_V1}::cosmetic::COSMETIC`, typeArgs: [ ] as [], isPhantom: COSMETIC.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => COSMETIC.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => COSMETIC.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => COSMETIC.fromBcs( data, ), bcs: COSMETIC.bcs, fromJSONField: (field: any) => COSMETIC.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => COSMETIC.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => COSMETIC.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => COSMETIC.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => COSMETIC.fetch( client, id, ), new: ( fields: COSMETICFields, ) => { return new COSMETIC( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromSuiObjectData( data: SuiObjectData ): COSMETIC { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isCOSMETIC(data.bcs.type)) { throw new Error(`object at is not a COSMETIC object`); }

 return COSMETIC.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return COSMETIC.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
 ...
 return COSMETIC.fromSuiObjectData( res.data ); }
...
export interface CosmeticFields { id: ToField<UID>; hash: ToField<Vector<"u8">>; name: ToField<String>; imageUrl: ToField<String>; modelUrl: ToField<String>; textureUrl: ToField<String>; type: ToField<String>; formattedType: ToField<String>; colourWay: ToField<String>; edition: ToField<String>; manufacturer: ToField<String>; rarity: ToField<String>; wearRating: ToField<"u64">; misc: ToField<VecMap<String, String>> }
...
export class Cosmetic implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly hash: ToField<Vector<"u8">>; readonly name: ToField<String>; readonly imageUrl: ToField<String>; readonly modelUrl: ToField<String>; readonly textureUrl: ToField<String>; readonly type: ToField<String>; readonly formattedType: ToField<String>; readonly colourWay: ToField<String>; readonly edition: ToField<String>; readonly manufacturer: ToField<String>; readonly rarity: ToField<String>; readonly wearRating: ToField<"u64">; readonly misc: ToField<VecMap<String, String>>

 private constructor(typeArgs: [], fields: CosmeticFields, ) { this.$fullTypeName = composeSuiType( Cosmetic.$typeName, ...typeArgs ) as `${typeof PKG_V1}::cosmetic::Cosmetic`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.hash = fields.hash;; this.name = fields.name;; this.imageUrl = fields.imageUrl;; this.modelUrl = fields.modelUrl;; this.textureUrl = fields.textureUrl;; this.type = fields.type;; this.formattedType = fields.formattedType;; this.colourWay = fields.colourWay;; this.edition = fields.edition;; this.manufacturer = fields.manufacturer;; this.rarity = fields.rarity;; this.wearRating = fields.wearRating;; this.misc = fields.misc; }
 ...
 id: UID.bcs, hash: bcs.vector(bcs.u8()), name: String.bcs, image_url: String.bcs, model_url: String.bcs, texture_url: String.bcs, type: String.bcs, formatted_type: String.bcs, colour_way: String.bcs, edition: String.bcs, manufacturer: String.bcs, rarity: String.bcs, wear_rating: bcs.u64(), misc: VecMap.bcs(String.bcs, String.bcs)

}) };

 static fromFields( fields: Record<string, any> ): Cosmetic { return Cosmetic.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), hash: decodeFromFields(reified.vector("u8"), fields.hash), name: decodeFromFields(String.reified(), fields.name), imageUrl: decodeFromFields(String.reified(), fields.image_url), modelUrl: decodeFromFields(String.reified(), fields.model_url), textureUrl: decodeFromFields(String.reified(), fields.texture_url), type: decodeFromFields(String.reified(), fields.type), formattedType: decodeFromFields(String.reified(), fields.formatted_type), colourWay: decodeFromFields(String.reified(), fields.colour_way), edition: decodeFromFields(String.reified(), fields.edition), manufacturer: decodeFromFields(String.reified(), fields.manufacturer), rarity: decodeFromFields(String.reified(), fields.rarity), wearRating: decodeFromFields("u64", fields.wear_rating), misc: decodeFromFields(VecMap.reified(String.reified(), String.reified()), fields.misc) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Cosmetic { if (!isCosmetic(item.type)) { throw new Error("not a Cosmetic type");

 }

 return Cosmetic.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), hash: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.hash), name: decodeFromFieldsWithTypes(String.reified(), item.fields.name), imageUrl: decodeFromFieldsWithTypes(String.reified(), item.fields.image_url), modelUrl: decodeFromFieldsWithTypes(String.reified(), item.fields.model_url), textureUrl: decodeFromFieldsWithTypes(String.reified(), item.fields.texture_url), type: decodeFromFieldsWithTypes(String.reified(), item.fields.type), formattedType: decodeFromFieldsWithTypes(String.reified(), item.fields.formatted_type), colourWay: decodeFromFieldsWithTypes(String.reified(), item.fields.colour_way), edition: decodeFromFieldsWithTypes(String.reified(), item.fields.edition), manufacturer: decodeFromFieldsWithTypes(String.reified(), item.fields.manufacturer), rarity: decodeFromFieldsWithTypes(String.reified(), item.fields.rarity), wearRating: decodeFromFieldsWithTypes("u64", item.fields.wear_rating), misc: decodeFromFieldsWithTypes(VecMap.reified(String.reified(), String.reified()), item.fields.misc) } ) }

 static fromBcs( data: Uint8Array ): Cosmetic { return Cosmetic.fromFields( Cosmetic.bcs.parse(data) ) }

 toJSONField() { return {

 id: this.id,hash: fieldToJSON<Vector<"u8">>(`vector<u8>`, this.hash),name: this.name,imageUrl: this.imageUrl,modelUrl: this.modelUrl,textureUrl: this.textureUrl,type: this.type,formattedType: this.formattedType,colourWay: this.colourWay,edition: this.edition,manufacturer: this.manufacturer,rarity: this.rarity,wearRating: this.wearRating.toString(),misc: this.misc.toJSONField(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField( field: any ): Cosmetic { return Cosmetic.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id), hash: decodeFromJSONField(reified.vector("u8"), field.hash), name: decodeFromJSONField(String.reified(), field.name), imageUrl: decodeFromJSONField(String.reified(), field.imageUrl), modelUrl: decodeFromJSONField(String.reified(), field.modelUrl), textureUrl: decodeFromJSONField(String.reified(), field.textureUrl), type: decodeFromJSONField(String.reified(), field.type), formattedType: decodeFromJSONField(String.reified(), field.formattedType), colourWay: decodeFromJSONField(String.reified(), field.colourWay), edition: decodeFromJSONField(String.reified(), field.edition), manufacturer: decodeFromJSONField(String.reified(), field.manufacturer), rarity: decodeFromJSONField(String.reified(), field.rarity), wearRating: decodeFromJSONField("u64", field.wearRating), misc: decodeFromJSONField(VecMap.reified(String.reified(), String.reified()), field.misc) } ) }
