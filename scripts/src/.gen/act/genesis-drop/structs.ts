...
import {Item} from "../genesis-shop/structs";
...
export class AvatarTicket implements StructClass { static readonly $typeName = `${PKG_V1}::genesis_drop::AvatarTicket`; static readonly $numTypeParams = 0;

 readonly $typeName = AvatarTicket.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::genesis_drop::AvatarTicket`;
...
export class GenesisPass implements StructClass { static readonly $typeName = `${PKG_V1}::genesis_drop::GenesisPass`; static readonly $numTypeParams = 0;

 readonly $typeName = GenesisPass.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::genesis_drop::GenesisPass`;
 ...
 static reified( ): GenesisPassReified { return { typeName: GenesisPass.$typeName, fullTypeName: composeSuiType( GenesisPass.$typeName, ...[] ) as `${typeof PKG_V1}::genesis_drop::GenesisPass`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GenesisPass.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GenesisPass.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GenesisPass.fromBcs( data, ), bcs: GenesisPass.bcs, fromJSONField: (field: any) => GenesisPass.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GenesisPass.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GenesisPass.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => GenesisPass.fetch( client, id, ), new: ( fields: GenesisPassFields, ) => { return new GenesisPass( [], fields ) }, kind: "StructClassReified", } }
...
export class Sale implements StructClass { static readonly $typeName = `${PKG_V1}::genesis_drop::Sale`; static readonly $numTypeParams = 0;

 readonly $typeName = Sale.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::genesis_drop::Sale`;
 ...
 static reified( ): SaleReified { return { typeName: Sale.$typeName, fullTypeName: composeSuiType( Sale.$typeName, ...[] ) as `${typeof PKG_V1}::genesis_drop::Sale`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Sale.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Sale.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Sale.fromBcs( data, ), bcs: Sale.bcs, fromJSONField: (field: any) => Sale.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Sale.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Sale.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Sale.fetch( client, id, ), new: ( fields: SaleFields, ) => { return new Sale( [], fields ) }, kind: "StructClassReified", } }
