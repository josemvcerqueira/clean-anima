...
export function isItem(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::act_genesis_shop::Item`; }
...
export class Item implements StructClass { static readonly $typeName = `${PKG_V1}::act_genesis_shop::Item`; static readonly $numTypeParams = 0;

 readonly $typeName = Item.$typeName;

 readonly $fullTypeName: `${typeof PKG_V1}::act_genesis_shop::Item`;
 ...
 private constructor(typeArgs: [], fields: ItemFields, ) { this.$fullTypeName = composeSuiType( Item.$typeName, ...typeArgs ) as `${typeof PKG_V1}::act_genesis_shop::Item`; this.$typeArgs = typeArgs;
...
export function isGenesisShop(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V1}::act_genesis_shop::GenesisShop`; }
