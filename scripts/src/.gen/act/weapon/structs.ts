...
export interface WeaponFields { id: ToField<UID>; hash: ToField<Vector<"u8">>; name: ToField<String>; imageUrl: ToField<String>; modelUrl: ToField<String>; textureUrl: ToField<String>; slot: ToField<String>; colourWay: ToField<String>; edition: ToField<String>; manufacturer: ToField<String>; rarity: ToField<String>; wearRating: ToField<"u64">; killCount: ToField<"u64">; upgrades: ToField<Vector<Upgrade>>; misc: ToField<VecMap<String, String>> }
...
export class Weapon implements StructClass { static readonly $typeName = `${PKG_V1}::weapon::Weapon`; static readonly $numTypeParams = 0;
 ...
 readonly id: ToField<UID>; readonly hash: ToField<Vector<"u8">>; readonly name: ToField<String>; readonly imageUrl: ToField<String>; readonly modelUrl: ToField<String>; readonly textureUrl: ToField<String>; readonly slot: ToField<String>; readonly colourWay: ToField<String>; readonly edition: ToField<String>; readonly manufacturer: ToField<String>; readonly rarity: ToField<String>; readonly wearRating: ToField<"u64">; readonly killCount: ToField<"u64">; readonly upgrades: ToField<Vector<Upgrade>>; readonly misc: ToField<VecMap<String, String>>
 ...
 id: UID.bcs, hash: bcs.vector(bcs.u8()), name: String.bcs, image_url: String.bcs, model_url: String.bcs, texture_url: String.bcs, slot: String.bcs, colour_way: String.bcs, edition: String.bcs, manufacturer: String.bcs, rarity: String.bcs, wear_rating: bcs.u64(), kill_count: bcs.u64(), upgrades: bcs.vector(Upgrade.bcs), misc: VecMap.bcs(String.bcs, String.bcs)
